...
def move():
    ...
    for drone in reddrones:
      ...
      print "After  drone behavior:    " + str(drone.position) + "  Velocity: " +  str(drone.velocity) + "   temp: " + str(drone.__temp)
      if FIRE:
        fire(drone, reddrones, bluedrones)
      drone.move()
      print "After drone move method: " + str(drone.position) + "  Velocity: " +  str(drone.velocity)
      outofbounds(drone, reddrones)
      print "After move position: " + str(drone.position) + "  Velocity: " +  str(drone.velocity)
      print  "Enemy centroid:  " + str(drone.distanceToEnemy)
